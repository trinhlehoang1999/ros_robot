...
#include <ankbot_msgs/SensorState.h>
#include <ankbot_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const ankbot_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == ankbot_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == ankbot_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const ankbot_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  ankbot_msgs::VersionInfo version;
...
int main(int argc, char **argv)
{
  ...
  tb3_version_info_pub = nh.advertise<ankbot_msgs::VersionInfo>("version_info", 10);
